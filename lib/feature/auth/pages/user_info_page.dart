...
import 'package:chitchat/common/widgets/short_h_bar.dart';
      ...
      builder: (context) {
        return Column(
          ...
          children: [
            ...
            Divider(color: context.theme.greyColor!.withOpacity(0.10)),
  ...
  imagePickerIcon({
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          text,
          style: TextStyle(color: context.theme.greyColor, fontSize: 14),
        ),
      ],
    );
  }
